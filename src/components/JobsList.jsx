  ...
  return (
    <div>
      <div className="container-sm">
        ...
        <div className="row">
          <div className="col-lg-5 col-md-12">
            <h2 className='detail text-left'>Embracing Innovation, Partnering with Tech Titans</h2>
            <p className='p-text-gray'>Empowering top-notch Filipino software engineers to collaborate with renowned global tech companies, unlocking limitless opportunities for career growth and skill enhancement within international engineering teams. <br /><br />
        ...
        <div className='row text-center'>
          ...
          <h1 className='topic2'>JEM Employee Perks & Benefits</h1>
          <p className='para text-center mx-10'>Empowering People, Driving Success <br/>
          Caring for Our Team, Fueling Our Success</p>
          </div>
        </div>
        <div className="row">
          <div className="col-md-6">
            <h6 className='perks text-left'>Health First</h6>
            <p className='p-text-gray'>Prioritizing well-being and safety above all else.</p>
            <br />
            <h6 className='perks text-left'>Education</h6>
            <p className='p-text-gray'>The process of acquiring knowledge, skills, and understanding through formal instruction or self-learning</p>
            <br />
            <h6 className='perks text-left'>Social</h6>
            <p className='p-text-gray'>Significance and impact of one's professional interactions, relationships, and contributions on the well-being and cohesion of the broader community or society.</p>
          </div>
          <div className="col-md-6">
            <h6 className='benefits text-left'>Mental Health & Wellness</h6>
            <p className='p-text-gray'>Encompass the promotion and support of employees' emotional well-being, psychological resilience, and work-life balance to foster a healthy and productive workforce.</p>
            <br />
            <h6 className='benefits text-left'>Work from Home</h6>
            <p className='p-text-gray'>Carrying out their job responsibilities remotely, typically from their own residences, using digital communication and collaboration tools.</p>
            <br />
            <h6 className='benefits text-left'>Health Maintenance Organization</h6>
            <p className='p-text-gray'>Healthcare insurance plan that typically requires members to choose a primary care physician and obtain referrals for specialist care within a network of healthcare providers.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container-sm">
        ...
        <div className="jobs">
          <Accordion defaultActiveKey="0" className='jobs mt-5'>
